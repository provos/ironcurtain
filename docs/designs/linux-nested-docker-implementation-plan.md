...
The implementation described below is now in the working tree. The acceptance
...
| Coverage limits               | CLI, PTY and workflow smoke runs use Claude. No all-mode-by-adapter or complete IPv4/IPv6/DNS/LAN/metadata matrix is claimed. No fresh macOS live run; native Linux Engine and Linux arm64 remain unqualified.   |
