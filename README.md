...
- Node.js 24 or 26 — the even-numbered major lines IronCurtain tests. Both install prebuilt `isolated-vm` binaries. Node 25 is unsupported and untested.
...
| **Node version errors**                 | Supported Node.js lines are 24 and 26. Both install prebuilt `isolated-vm` binaries. Other major versions are rejected by `ironcurtain doctor`.                                                                                                          |
