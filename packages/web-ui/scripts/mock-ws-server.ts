...
function buildPastRunFixtures(): MockPastRun[] {
  return [
    ...
    },
    {
      ...
      phase: 'failed',
      currentState: 'scanner_pass',
      lastState: 'scanner_pass',
      taskDescription: 'Assess auth middleware for authorization regressions',
      round: 1,
      maxRounds: 4,
      totalTokens: 12300,
    ...
    },
    {
      ...
      name: 'appsec-assessment',
      phase: 'interrupted',
      currentState: 'safe_validation',
      lastState: 'safe_validation',
      taskDescription: 'Validate JSON-RPC dispatch findings with local regression tests',
      round: 2,
      maxRounds: 5,
      totalTokens: 33600,
