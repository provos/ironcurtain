/**
 * TF-IDF word scorer for the workflow theater rain panel.
 *
...
import { type WordDropSource } from './matrix-rain/word-drop-types.js';

// Re-export so downstream consumers that previously imported the inline
// type from this module keep compiling.
