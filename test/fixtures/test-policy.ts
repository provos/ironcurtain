    ...
    'google-workspace': {
      ...
      tools: [
        ...
        },
        {
          ...
          sideEffects: false,
          args: { messageId: ['google-resource-id'] },
        },
        {
          ...
          sideEffects: false,
          args: { calendarId: ['google-resource-id'], maxResults: ['none'] },
        },
        {
        ...
        },
        {
          ...
          sideEffects: false,
          args: { fileId: ['google-resource-id'] },
        },
        // Mutation operations
        {
        ...
        },
        {
          ...
          sideEffects: true,
          args: { fileId: ['google-resource-id'], email: ['email-address'], role: ['none'] },
        },
        {
        ...
        },
        {
          ...
          sideEffects: true,
          args: { messageIds: ['google-resource-id'], addLabels: ['none'], removeLabels: ['none'] },
        },
      ],
    },
    fetch: {
